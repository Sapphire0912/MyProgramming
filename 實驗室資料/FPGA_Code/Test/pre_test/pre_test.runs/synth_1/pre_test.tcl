...
synth_design -top pre_test -part xc7z020clg484-1


# disable binary constraint mode for synth run checkpoints
set_param constraints.enableBinaryConstraints false
write_checkpoint -force -noxdef pre_test.dcp
create_report "synth_1_synth_report_utilization_0" "report_utilization -file pre_test_utilization_synth.rpt -pb pre_test_utilization_synth.pb"
