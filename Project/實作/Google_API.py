...
entry_output = tk.Entry(win, textvariable = _output, width = 50)
entry_output.grid(row = 1, column = 1)

# 選擇輸入語言, 選擇翻譯語言(先做 中英日三種)
# 使用核取方塊來做
rad_l = tk.IntVar()
radio = tk.Radiobutton(win, variable = rad_l, value = "1", text = "中文", font = ft)
radio.grid(row = 2, column = 0, sticky = 'e')
radio = tk.Radiobutton(win, variable = rad_l, value = "2", text = "英文", font = ft)
radio.grid(row = 3, column = 0, sticky = 'e')
radio = tk.Radiobutton(win, variable = rad_l, value = "3", text = "日文", font = ft)
...
rad_r = tk.IntVar()
radio = tk.Radiobutton(win, variable = rad_r, value = "1", text = "中文", font = ft)
radio.grid(row = 2, column = 1)
radio = tk.Radiobutton(win, variable = rad_r, value = "2", text = "英文", font = ft)
radio.grid(row = 3, column = 1)
radio = tk.Radiobutton(win, variable = rad_r, value = "3", text = "日文", font = ft)
